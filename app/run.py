    ...
    graphs = [
        {
            ...
            'layout': {
                'title': 'Distribution of Message (related or not)',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
        ...
        },
        {
            ...
            'layout': {
                'title': 'Distribution of message by genres and related or not',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
